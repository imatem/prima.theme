...
#
#  $ bin/test -s prima.theme -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src prima.theme.testing.PRIMA_THEME_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/prima/theme/tests/robot/test_example.robot
#
